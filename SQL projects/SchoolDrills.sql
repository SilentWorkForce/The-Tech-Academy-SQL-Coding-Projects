...
SELECT specialist_fname, specialist_lname, specialist_contact FROM tbl_specialist WHERE specialist_id BETWEEN 1 AND 1;
...
CREATE TABLE tbl_contacts (
	...
	persons_address VARCHAR (50) NOT NULL
);
...
INSERT INTO tbl_contacts
	(persons_address, persons_contact)
	VALUES
	('1100 W ST','555-232-4567'),
	('2200 E ST','555-232-4567'),
	('3300 S ST','555-232-4567'),
	('4400 N ST','555-232-4567'),
	('5500 S ST','555-232-4567')
;
...
SELECT
	...
	a2.persons_address
	FROM tbl_persons a1
	INNER JOIN tbl_contacts a2 ON a2.persons_contact = a2.persons_contact
	;
